#!/usr/bin/env python3
"""
BotController gamedata update module

Updates BotController's gamedata.json with generated CS2 signatures and offsets
"""
...
MODULE_NAME = "BotController"
MODULE_ENABLED = True

GAMEDATA_PATH = "config/addons/BotController/gamedata.json"

SIGNATURE_ALIASES = {
    "CCSPlayer_WeaponServices::GetSlot": "CCSPlayer_WeaponServices_GetSlot",
    "CCSPlayer_WeaponServices::SelectItem": "CCSPlayer_WeaponServices_SelectItem",
    "CCSPlayer_MovementServices::ProcessMovement": "CCSPlayer_MovementServices_ProcessMovement",
    "CCSBot::Upkeep": "CCSBot_Upkeep",
}

OFFSET_ALIASES = {
    "CCSBot::AiTickedFlag": "CCSBot_AiTickedFlag",
    "CCSBot::Pawn": "CCSBot_m_pPawn",
    "CCSBot::Profile": "CCSBot_m_pProfile",
    "CCSPlayerPawn::WeaponServices": "CCSPlayerPawn_m_pWeaponServices",
    "CCSPlayerPawn::Controller": "CCSPlayerPawn_m_hController",
    "CCSPlayerPawn::OriginalController": "CCSPlayerPawn_m_hOriginalController",
    "CCSPlayerPawn::EyeAngles": "CCSPlayerPawn_m_angEyeAngles",
    "CCSPlayerPawn::ViewAngle": "CCSPlayerPawn_v_angle",
    "CCSPlayer_WeaponServices::ActiveWeapon": "CPlayer_WeaponServices_m_hActiveWeapon",
    "CBasePlayerWeapon::ItemDefIndex": "CEconItemView_m_iItemDefinitionIndex",
    "CBaseEntity::Identity": "CEntityInstance_m_pEntity",
    "CEntityIdentity::EHandle": "CEntityIdentity_m_EHandle",
    "CBaseEntity::GameSceneNode": "CBaseEntity_m_pGameSceneNode",
    "CGameSceneNode::AbsOrigin": "CGameSceneNode_m_vecAbsOrigin",
}


def update(yaml_data, func_lib_map, platforms, dist_dir, alias_to_name_map, debug=False):
    """Update BotController gamedata.json from generated YAML data"""
    gamedata_path = os.path.join(dist_dir, GAMEDATA_PATH)

    if not os.path.exists(gamedata_path):
        print(f"  Warning: BotController gamedata not found: {gamedata_path}")
        return 0, 0, [], []
